...
void Opanalysis::DoMKnownmodel(std::shared_ptr<TracesMatrix>& traces_matrix, std::shared_ptr<TracesMatrix>& power_model, unsigned long startingsample, unsigned long numsamples, unsigned long ntraces, char noiseAssumption, char out_model, int ptx)
{
   ...
   std::string fn = "/Users/jacopo/Dropbox/ArgTraces/DoMKnownmodel/ptx" + std::to_string(ptx) + "numtraces" + std::to_string(ntraces) + "nsam" + std::to_string(numsamples) + "noise" + noiseAssumption + "model" + out_model + ".bin";
   Opanalysis::saveInFile(arg, fn.c_str(), numsamples);
}

void Opanalysis::DoMUnknownmodel(std::shared_ptr<TracesMatrix>& traces_matrix, std::shared_ptr<TracesMatrix>& power_model, unsigned long startingsample, unsigned long numsamples, unsigned long ntraces, char out_model, double pel_coeff_squared, double plat_noise, int ptx)
{
   AnalysisType y(ntraces,1);
   ...
   std::string fn = "/Users/jacopo/Dropbox/ArgTraces/DoMUnknownmodel/ptx" + std::to_string(ptx) + "numtraces" + std::to_string(ntraces) + "nsam" + std::to_string(numsamples) + "Pelgromcoefficient" + std::to_string((int)pel_coeff_squared) + "Platformnoise" + std::to_string((int)plat_noise) + "model" + out_model + ".bin";
   Opanalysis::saveInFile(arg, fn.c_str(), numsamples);
}

void Opanalysis::CPA(std::shared_ptr<TracesMatrix>& traces_matrix, std::shared_ptr<TracesMatrix>& power_model, unsigned long startingsample, unsigned long numsamples, unsigned long ntraces, char out_model, int ptx)
{
  ...
  std::string fn = "/Users/jacopo/Dropbox/ArgTraces/CPA/ptx" + std::to_string(ptx) + "numtraces" + std::to_string(ntraces) + "nsam" + std::to_string(numsamples) + "model" + out_model + ".bin";
  Opanalysis::saveInFile(arg, fn.c_str(), numsamples);
